...
export default class FeaturesSection extends React.Component {
    render() {
        ...
        return (
            <section className={classNames('section', 'features-section', {'bg-blue': bg_color === 'blue', 'bg-gray': bg_color === 'gray', 'pt-4': padding_top === 'small', 'pt-6': (padding_top === 'medium') || (padding_top === 'large'), 'pt-md-8': padding_top === 'large', 'pb-4': padding_bottom === 'small', 'pb-6': (padding_bottom === 'medium') || (padding_bottom === 'large'), 'pb-md-8': padding_bottom === 'large'})}>
            	<div className="container">
            		...
            		<div className={classNames('features-list', {'mt-5': _.get(section, 'title', null) || _.get(section, 'subtitle', null)})}>
